<?php
    ...
    $sql = "SELECT DISTINCT * FROM publish WHERE cod_user='$cod_user' UNION SELECT DISTINCT * FROM publish WHERE cod_user=(SELECT cod_answer FROM 
    friendship WHERE cod_ask='$cod_user' and status='1') UNION SELECT DISTINCT * FROM publish WHERE cod_user=(SELECT cod_ask FROM 
    friendship WHERE cod_answer='$cod_user' and status='1') order by data_post";
