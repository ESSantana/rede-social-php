    ...
    <div class="w3-col m12">
        <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding publishcontainer">
                <form method="POST" action="publicar_action.php">
                    <textarea class="w3-border w3-padding" type="text" placeholder="O que você está pensando?" name="publish" rows="3"></textarea>
